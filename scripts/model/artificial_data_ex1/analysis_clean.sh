...
PYTHONHASHSEED=0 python "${project_dir}/src/artificial_data_ex1/analysis_clean.py" \
        --pred_file="${project_dir}/logs/artificial_data_ex1/${data_type}/${prompt_type}/${model}/${depth}/test.jsonl" \
